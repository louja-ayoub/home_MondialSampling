...
const Product = ({ product }) => {
    ...
    return (
        <Link to={`/productDetail/${product.id}`}
            ...
            <img class="rounded-2xl object-cover w-80" src={product.imageUrl} alt="jacket image" />
            <div
                ...
                <div class="flex items-center justify-between mb-2">
                    ...
                    <h6 class="font-semibold text-base leading-7 text-blue-600 text-right"> {translate('more_detail')} </h6>
                </div>
            </div>
        </Link>
    );
